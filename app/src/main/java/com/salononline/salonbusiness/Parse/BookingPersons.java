...
public class BookingPersons implements Serializable {
    ...
    private String queueStatus,servingTime,queueNumber;

    public BookingPersons() {
    }

    public BookingPersons(String userName, String gender, String userMobile, List<BookingServices> bookingServices, String barberName, String barberUuid, Double subTotal, String totalServiceTime, Integer noOfServices, String queueStatus, String servingTime, String queueNumber) {

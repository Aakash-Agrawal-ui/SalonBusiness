...
public class ParseGetBarber {
    private String barberUuid,shopUuid,barberName,gender,barberState;

    public ParseGetBarber() {
    }

    public ParseGetBarber(String barberUuid, String shopUuid, String barberName, String gender, String barberState) {

...
public class ParseAllBarbersData {
    private String barberUuid,shopUuid,barberName,gender,barberState;

    public ParseAllBarbersData() {
    }

    public ParseAllBarbersData(String barberUuid, String shopUuid, String barberName, String gender, String barberState) {

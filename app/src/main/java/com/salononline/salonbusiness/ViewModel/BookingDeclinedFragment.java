...
public class BookingDeclinedFragment extends Fragment {
    View view;
    private String token,shopUuid;
    private List<BookingSingleItem> bookingSingleItems;
    private RecyclerView declinedListRecyclerView;
    GetBookingHistoryAdapter getBookingHistoryAdapter;

    public BookingDeclinedFragment(String token,String shopUuid) {
        this.token=token;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.booking_profile_declined_layout,container,false);
        declinedListRecyclerView=view.findViewById(R.id.bookingDeclinedListRecyclerView);

        getBookingHistoryAdapter=new GetBookingHistoryAdapter(getContext(),bookingSingleItems,token,shopUuid);
        declinedListRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        declinedListRecyclerView.setAdapter(getBookingHistoryAdapter);
        return view;
    }
    @Override

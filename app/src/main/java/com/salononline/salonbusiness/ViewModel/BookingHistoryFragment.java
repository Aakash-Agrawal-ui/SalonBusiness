...
public class BookingHistoryFragment extends Fragment {
    ...
    public BookingHistoryFragment(String token,String shopUuid) {
        this.token=token;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bookingListRecyclerView=view.findViewById(R.id.bookingHistoryListRecyclerView);
        ...
        bookingListRecyclerView.setAdapter(getBookingHistoryAdapter);
        return view;
    }
    @Override

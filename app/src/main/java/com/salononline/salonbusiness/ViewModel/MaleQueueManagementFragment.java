...
public class MaleQueueManagementFragment extends Fragment {
    View view;
    String token,shopUuid,barberUuid;
    private RecyclerView maleQueueRecyclerView;
    ...
    public MaleQueueManagementFragment(String token,String shopUuid,String barberUuid) {
        this.token=token;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.male_queue_management,container,false);
        maleQueueRecyclerView=view.findViewById(R.id.maleBarberQueueRecyclerView);

        queueBarberManageAdapter=new QueueBarberManageAdapter(getContext(),bookingQueuePersonsList,token,barberUuid,shopUuid);
        maleQueueRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        maleQueueRecyclerView.setAdapter(queueBarberManageAdapter);

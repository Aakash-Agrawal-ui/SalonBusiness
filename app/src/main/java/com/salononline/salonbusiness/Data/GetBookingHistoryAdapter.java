...
public class GetBookingHistoryAdapter extends RecyclerView.Adapter<GetBookingHistoryAdapter.ViewHolder>{
    private Context context;
    private List<BookingSingleItem> bookingSingleItemList;

    private String token,shopUuid;
    public GetBookingHistoryAdapter(Context context, List<BookingSingleItem> bookingSingleItemList, String token, String shopUuid) {
    ...
    @NonNull
    @Override
    public GetBookingHistoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.booking_layout,parent,false);
        return new GetBookingHistoryAdapter.ViewHolder(view,context,token,shopUuid);
    }

    @Override
    public void onBindViewHolder(@NonNull GetBookingHistoryAdapter.ViewHolder holder, int position) {
